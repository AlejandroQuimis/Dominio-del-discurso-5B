...
create or replace function control_tramite() returns trigger as $control_tramite$
  declare
  	contador_tramite int;
  	tramite_limite int;
  begin 
   select count(*) into contador_tramite from persona where id_tramite_tramite1 = new.id_tramite_tramite1;
   ...
   return new;
   raise exception 'Se ha agregado con exito..';
  end;
